<?php
/*
  Plugin Name: SCD - Smart Currency Detector - Premium Variant for WCFM
...
function scd_premium_notice($tmesage) {
    ...
    return '<div class="notice notice-warning is-dismissible">
        <p>The SCD-Multivendors for wcfm license key has not been activated or has expired, so you will be unable
...
if(!is_plugin_active('scd-smart-currency-detector/index.php')){
    echo '<h3 style="color:red;">SCD Multivendors for WCFM require scd-smart-currency-detector before use, please <a target="__blank" href="https://wordpress.org/plugins/scd-smart-currency-detector/"> download and install it here</a><h3>';    
}
}

if (true && in_array('scd-smart-currency-detector/index.php', apply_filters('active_plugins', get_option('active_plugins')))){
